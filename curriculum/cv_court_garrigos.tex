...
\section{Responsibilities}
	\subsection{Student supervision}
		\cvitem{2025-2028}{Théo Moret. Undergrad + PhD thesis.}
		\cvitem{2023-2027}{Lucas Ketels. Undergrad + PhD thesis.}
	...
	\subsection{Seminars, Events}
		...
		\cvitem{2015--2017}{Organizer of the Machine Learning Tutorials, IIT (Genova) and MIT (Boston)}
%\iflongcv{%
...
%
%
\section{Selected publications} % Here we use the data from papers.csv
%	\cventrylong{}{{Publications in international specialized journals}}{}{}{}{%
%		\begin{itemize}
